...
template.innerHTML = /* HTML */ `
  <style>
    .md-header-wrapper {
      ...
      --_header-max-width: var(--header-max-width, 40rem);
      --_header-min-height: var(--header-min-height, 0);
      --_header-gap: var(--header-gap, 0);
      --_header-font-size: var(--header-font-size, 2rem);

      --_logo-letter-size: var(--logo-letter-size, 4rem);
      --_logo-size: var(--logo-size, 1.1em);
